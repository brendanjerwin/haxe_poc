...
public  class Std
{
	...
	public static   boolean is(java.lang.Object v, java.lang.Object t)
	{
		...
		{
			java.lang.String __temp_svar29 = (name);
			int __temp_hash31 = __temp_svar29.hashCode();
			switch (__temp_hash31)
			{
				case 761287205:case -1325958191:
				{
					if (( (( ( __temp_hash31 == 761287205 ) && __temp_svar29.equals("java.lang.Double") )) || __temp_svar29.equals("double") )) 
					{
				...
				case 1063877011:
				{
					if (__temp_svar29.equals("java.lang.Object")) 
					{
						return true;
					}
				...
				{
					if (( (( ( __temp_hash31 == -2056817302 ) && __temp_svar29.equals("java.lang.Integer") )) || __temp_svar29.equals("int") )) 
					{
				...
				{
					if (( (( ( __temp_hash31 == 344809556 ) && __temp_svar29.equals("java.lang.Boolean") )) || __temp_svar29.equals("boolean") )) 
					{
