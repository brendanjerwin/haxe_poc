	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		
		{
			...
			switch (__temp_hash37)
			{
				...
				{
					if (( (( ( __temp_hash37 == -672261858 ) && __temp_svar35.equals("Integer") )) || __temp_svar35.equals("int") )) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar35.equals("Object")) 
					{
						__temp_executeDef36 = false;
						return "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash37 == 2052876273 ) && __temp_svar35.equals("Double") )) || __temp_svar35.equals("double") )) 
					{
						__temp_executeDef36 = false;
						return "Float";
					}
